...
int rows[] = {A0, A1, A2, A3, A4, A5, A6}; // (add A7, A8, A9 at the end for 10 strips) these can be thought of as up and down sliders; A0 is the left-most UD slider, A6 is the right-most
int cols[] = {6, 5, 4, 3, 2, 1, 0}; // (add 9, 8, 7 at the beginning for 10 strips) these can be thought of as left and right sliders; 11 is the top-most LR slider, 5 is the lowest
